...
const homeButtonClass =
  'inline-flex min-h-11 items-center justify-center border-2 border-white px-5 py-3 text-sm font-extrabold uppercase text-white transition-colors hover:bg-white hover:text-[#2774AE]';
  ...
  return (
    <>
      <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-[#2774AE] px-6 text-center transition-colors duration-300 dark:bg-black md:px-16">
        ...
        />
        <div className="pointer-events-none absolute inset-0 flex select-none items-center justify-end overflow-hidden pr-[5%]">
        ...
        <div className="relative z-10 w-full max-w-5xl py-8">
          <h1
            className="mb-6 text-[clamp(2.8rem,8vw,7rem)] font-bold leading-[1.05] tracking-tight text-white"
          ...
          <div className="mx-auto mb-10 h-[3px] w-12 rounded-full bg-[#FFD100]" />
      ...
      <section id="register" className="bg-[#2774AE] px-6 py-28 transition-colors dark:bg-black md:px-16">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mx-auto mb-10 max-w-lg text-center text-base leading-relaxed text-[#DAEBFE] md:text-lg">
